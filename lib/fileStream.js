...
module.exports = class FileStream extends CallbackQueue {
    #bytes = 0;
    ...
    #queueSendFile(next, filepath) {
        ...
        return this.lastIndex
            ? this.push(this.destroyStream, null).response.report(this.#bytes).end(buffer, "utf8", () => process.nextTick(this.next))
