    ...
    function dataListener(data) {
        ...
        if (data.byteLength === 6)
            ...
            if (data.slice(6).toString() === "test") {
                const test = Buffer.allocUnsafe(10);
                test[0] = 129; test[1] = 131; test[2] = 0; test[3] = 0; test[4] = 0; test[5] = 0; test[6] = 97; test[7] = 97; test[8] = 112;
                this.write(test, () => console.log("written"));
            }
